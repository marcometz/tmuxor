...
def pane_view(src, p):
    return {
        ...
        "space_id": p.get("session", ""),
        "space_number": p["window_index"],
        "space_label": p["window_name"],
        "tab_id": p.get("tab_id", ""),
        "tab_number": p.get("tab_index", 0),
        "tab_label": p.get("tab_name", ""),
        "tab_panes": p.get("tab_panes", 0),
        "title": p["title"],
